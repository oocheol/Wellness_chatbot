window.onload = function () {
    ...
    utterance.rate = "5" // 속도; 최솟값: 0.1, 최댓값: 10

    // // 음성 바꿔보기
    // speechSynthesis.getVoices().forEach(function(voice) {
    //     console.log(voice.name, voice.default ? '(default)' :'');
    //   });
    // utterance.voice = speechSynthesis.getVoices().filter(function(voice) { return voice.name == 'Whisper'; })[0];
    // speechSynthesis.speak(msg);
    // utterance.voice = voice || voices[50]; // female voice // 
