...
def main():
    ...
    st.subheader("")
    st.markdown("""
        🙂 Wellness 챗봇 데이터(AI hub)와 일상대화 데이터를 kogpt2(SKT)에 fine-tuning한 챗봇
        """
        """
        🎈 각 챗봇 데이터의 감정(sentiment) 정보를 함께 생성하도록 학습하여 사용자에게 위로와 공감을 주도록 하였습니다.
        """)
    ...
    st.sidebar.text("정우철, oocheol@naver.com")
    st.sidebar.text("광주인공지능사관학교")
    
    st.subheader("참조")
    st.markdown("Wellness 챗봇: https://github.com/eunjiinkim/WellnessChatbot")
